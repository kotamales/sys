...
{
    function ebs_url($value='')
    {
        $CI =& get_instance();
        return base_url()  . 'themes/' . $CI->config->item('ebs_path') . $value;
    }
}
/**
 * Get XML URL
...
if ( ! function_exists('ebs_path'))
{
    function ebs_path($value='')
    {
        $CI =& get_instance();
        return FCPATH . 'themes/' . $CI->config->item('ebs_path') . $value;
    }
}
...
if ( ! function_exists('ebs_path_relative'))
{
    function ebs_path_relative($value='')
    {
        $CI =& get_instance();
        return './' . 'themes/' . $CI->config->item('ebs_path') . $value;
    }
}
// ------------------------------------------------------------------------
// EMBED HELPERS
