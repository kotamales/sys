...
class FrontendController extends MX_Controller
{
	...
	function get_combo_no_select($kel, $param=array()){
...
class BackendController extends MX_Controller
{
	...
	public $sts_open_coloums=false;
	public $sts_open_coloums_all=false;
	...
	function addField($data=array()){
		...
		if ($this->sts_open_coloums){
			$this->tmp_data['coloums'][$this->jml_coloums]['field'][]=$field;
		}
		
		if ($this->sts_open_coloums_all){
			$this->tmp_data['coloums_all'][$this->jml_coloums_all]['field'][]=$field;
		}
	}
	...
	function _setActionprivilege($nilai){
		$this->tmp_data['setActionprivilege']=$nilai;
	}
	...
	function set_Open_Coloums($title){
		...
		$this->tmp_data['coloums'][$this->jml_coloums]=array('title'=>$title,'id'=>'col-0' . count($this->tmp_data['coloums']));
	}
	...
	function set_Open_Coloums_All($title){
		...
		$this->tmp_data['coloums_all'][$this->jml_coloums_all]=array('title'=>$title,'id'=>'col-0' . count($this->tmp_data['coloums']));
	}
