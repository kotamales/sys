<!-- start about 
<section id="about" style="background:url(<?=img_url('travel.jpg');?>) no-repeat center center fixed;background-size:cover;">
-->
	<section id="about">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 col-sm-4 col-xs-12 wow fadeInLeft" data-wow-offset="50" data-wow-delay="0.6s">
					<div class="media">
						<div class="media-heading-wrapper">
							...
							<h3 class="media-heading">TIKET</h3>
						</div>
				...
				<div class="col-md-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-offset="50" data-wow-delay="0.9s">
					<div class="media">
						<div class="media-heading-wrapper">
							...
							<h3 class="media-heading">HOTEL</h3>
						</div>
						<div class="media-body">
				...
				<div class="col-md-4 col-sm-4 col-xs-12 wow fadeInRight" data-wow-offset="50" data-wow-delay="0.6s">
					<div class="media">
						<div class="media-heading-wrapper">
							...
							<h3 class="media-heading">PASSPORT & VISA</h3>
						</div>
						<div class="media-body">
