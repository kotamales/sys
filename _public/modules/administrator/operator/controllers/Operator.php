...
class Operator extends BackendController {
	...
	public function __construct()
	{
		...
		$this->set_Open_Tab('Data Petugas');
			...
			$this->addField(array('field'=>'nip', 'required'=>false, 'search'=>true, 'size'=>10));
			$this->addField(array('field'=>'nama_lengkap', 'required'=>true, 'search'=>true, 'size'=>40));
			$this->addField(array('field'=>'jabatan', 'size'=>40));
			$this->addField(array('field'=>'telp', 'size'=>15));
			$this->addField(array('field'=>'email', 'size'=>20));
		...
		$this->set_Table_List($this->tbl_master,'telp');
