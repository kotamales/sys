...
class Module extends BackendController {
	...
	public function __construct()
	{
		...
		$this->set_Open_Tab('Data Module');
			...
			$this->addField(array('field'=>'icon', 'input'=>'combo', 'combo'=>$this->arr_icons, 'search'=>true, 'size'=>20));
	...
	function buildItem($ad) {
		...
		$html .= "<div class='dd-handle dd3-handle'></div><div class='dd3-content'><i class='".$ad['icon']."'></i> <span class='judul text-primary'>" . $ad['title'] . ' <em>[<sub>'. $ad['nm_modul'] . '</sub>]</em> ' . $aktif . "</span> <span class='pull-right' style='margin-top:0px;'> <a href='".base_url($this->modul_name.'/edit/'.$ad['id'])."' class='edit_modul'><i class='fa fa-pencil-square-o'></i></a></span></div>";
