<?php 
	echo form_open_multipart(base_url('data-mesin/proses-import'),array('id'=>'form_input'));
?>
	...
	<aside class="col-md-12">
		<section class="box box-warning">
			...
			<div class="panel-body">
				...
				<ul>
				<li>Data yang akan di proses hanya data baru dan dimulai pada baris ke 4, sedangkan untuk data yang sudah pernah di import sebelumnya dapat di edit melalui menu Setup - Data Kode.</li>
